...
class Autocovnlayer(nn.Module):
    ...
    def forward(self,x,temperature_1,temperature_2):
        ...
        noise_dence_r1 = torch.rand((self.dence_num,N))[:,:,None,None,None,None].cuda()   ##[dence_num,N,1,1,1,1]
        ...
        noise_component_r1 = torch.rand((self.component_num,N))[:,:,None,None,None,None].cuda()   ##[dence_num,N,1,1,1,1]
